 ...
 * {@link RecyclerTmView.Adapter RecyclerView.Adapter}, and will signal the
...
public class AsyncListDiffer<T> {
     ...
     *
     * @see DiffUtil.DiffResult#dispatchUpdatesTo(RecyclerTmView.Adapter)
     */
    public AsyncListDiffer(@NonNull RecyclerTmView.Adapter adapter,
