...
public class GridLayoutManagerFixed extends GridLayoutManager {
    ...
    protected void recycleViewsFromStart(RecyclerTmView.Recycler recycler, int scrollingOffset,
        ...
        if (mShouldReverseLayout) {
            for (int i = childCount - 1; i >= 0; i--) {
                ...
                final RecyclerTmView.LayoutParams params = (RecyclerTmView.LayoutParams) child.getLayoutParams();
    ...
    @Override
    void layoutChunk(RecyclerTmView.Recycler recycler, RecyclerTmView.State state, LayoutState layoutState, LayoutChunkResult result) {
