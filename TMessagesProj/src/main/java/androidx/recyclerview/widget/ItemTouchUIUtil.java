 ...
 * {@link RecyclerTmView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary changes
...
public interface ItemTouchUIUtil {
     ...
     * RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, RecyclerTmView recyclerTmView, View view,
     ...
     * RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, RecyclerTmView recyclerTmView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(RecyclerTmView,
     * RecyclerTmView.ViewHolder)}
     */
    void clearView(View view);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#onSelectedChanged(
     * RecyclerTmView.ViewHolder, int)}
     */
