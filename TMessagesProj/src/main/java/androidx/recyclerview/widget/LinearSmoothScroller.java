...
/**
 * {@link RecyclerTmView.SmoothScroller} implementation which uses a {@link LinearInterpolator} until
 ...
 * <p>
 * If the {@link RecyclerTmView.LayoutManager} you are using does not implement the
 * {@link RecyclerTmView.SmoothScroller.ScrollVectorProvider} interface, then you must override the
 ...
 */
public class LinearSmoothScroller extends RecyclerTmView.SmoothScroller {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, RecyclerTmView.State state, Action action) {
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final RecyclerTmView.LayoutManager layoutManager = getLayoutManager();
