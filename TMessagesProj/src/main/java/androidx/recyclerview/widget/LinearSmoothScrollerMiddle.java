...
public class LinearSmoothScrollerMiddle extends RecyclerTmView.SmoothScroller {
    ...
    public int calculateDyToMakeVisible(View view) {
        ...
        final RecyclerTmView.LayoutParams params = (RecyclerTmView.LayoutParams) view.getLayoutParams();
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        RecyclerTmView.LayoutManager layoutManager = getLayoutManager();
