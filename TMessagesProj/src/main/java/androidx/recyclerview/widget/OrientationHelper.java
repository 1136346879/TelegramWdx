 ...
 * decorations.
 *
 * @see #createHorizontalHelper(RecyclerTmView.LayoutManager)
 * @see #createVerticalHelper(RecyclerTmView.LayoutManager)
 */
public abstract class OrientationHelper {

    private static final int INVALID_SIZE = Integer.MIN_VALUE;

    protected final RecyclerTmView.LayoutManager mLayoutManager;
    ...
    private OrientationHelper(RecyclerTmView.LayoutManager layoutManager) {
        mLayoutManager = layoutManager;
    }

    /**
     * Returns the {@link RecyclerTmView.LayoutManager LayoutManager} that
     * is associated with this OrientationHelper.
     */
    public RecyclerTmView.LayoutManager getLayoutManager() {
     ...
     * {@link RecyclerTmView.LayoutManager#onLayoutChildren(RecyclerTmView.Recycler,
     * RecyclerTmView.State)} method.
     *
     ...
     * its position
     *
     * @see RecyclerTmView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
     ...
     * @see RecyclerTmView.LayoutManager#getWidthMode()
     * @see RecyclerTmView.LayoutManager#getHeightMode()
     */
    ...
    public static OrientationHelper createOrientationHelper(
            RecyclerTmView.LayoutManager layoutManager, @RecyclerTmView.Orientation int orientation) {
        switch (orientation) {
            case HORIZONTAL:
    ...
    public static OrientationHelper createHorizontalHelper(
            RecyclerTmView.LayoutManager layoutManager) {
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(RecyclerTmView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
