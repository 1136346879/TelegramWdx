...
import androidx.recyclerview.widget.RecyclerTmView.ItemAnimator.ItemHolderInfo;
 ...
 */
public class RecyclerTmView extends ViewGroup implements ScrollingView,
     ...
     * {@link LayoutManager#onItemsChanged(RecyclerTmView)} should be called during the subsequent
     * measure/layout.
     *
     * @see #processDataSetCompletelyChanged(boolean)
     */
    ...
    public RecyclerTmView(@NonNull Context context) {
        this(context, null);
    }

    public RecyclerTmView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerTmView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return RecyclerTmView.class.getPackage().getName() + '.' + className;
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public int getChildCount() {
                return RecyclerTmView.this.getChildCount();
            }
            ...
            public void addView(View child, int index) {
                ...
                RecyclerTmView.this.addView(child, index);
                if (VERBOSE_TRACING) {
            ...
            public int indexOfChild(View view) {
                return RecyclerTmView.this.indexOfChild(view);
            }

            @Override
            public void removeViewAt(int index) {
                final View child = RecyclerTmView.this.getChildAt(index);
                if (child != null) {
                ...
                RecyclerTmView.this.removeViewAt(index);
                if (VERBOSE_TRACING) {
                    TraceCompat.endSection();
                }
            }
            ...
            public View getChildAt(int offset) {
                return RecyclerTmView.this.getChildAt(offset);
            }
            ...
            public void removeAllViews() {
                ...
                RecyclerTmView.this.removeAllViews();
            }
            ...
            public void attachViewToParent(View child, int index,
                ...
                RecyclerTmView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                RecyclerTmView.this.detachViewFromParent(offset);
            }
            ...
            public void onEnteredHiddenState(View child) {
                final ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onEnteredHiddenState(RecyclerTmView.this);
                }
            }
            ...
            public void onLeftHiddenState(View child) {
                final ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onLeftHiddenState(RecyclerTmView.this);
                }
            }
        });
    }
            ...
            void dispatchUpdate(AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case AdapterHelper.UpdateOp.ADD:
                        mLayout.onItemsAdded(RecyclerTmView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(RecyclerTmView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(RecyclerTmView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case AdapterHelper.UpdateOp.MOVE:
                        mLayout.onItemsMoved(RecyclerTmView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
    ...
    public void setLayoutManager(@Nullable LayoutManager layout) {
        ...
        mLayout = layout;
        if (layout != null) {
            if (layout.mRecyclerTmView != null) {
                throw new IllegalArgumentException("LayoutManager " + layout
                        + " is already attached to a RecyclerView:"
                        + layout.mRecyclerTmView.exceptionLabel());
            }
    ...
    /**
     * Set a {@link OnFlingListener} for this {@link RecyclerTmView}.
     * <p>
    ...
    /**
     * Get the current {@link OnFlingListener} from this {@link RecyclerTmView}.
     *
     ...
     * @see #addAnimatingView(RecyclerTmView.ViewHolder)
     ...
     * {@link RecyclerTmView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see RecyclerTmView.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link LayoutManager#smoothScrollToPosition(RecyclerTmView, State, int)} and create a
     * {@link SmoothScroller}.
     * <p>
     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link LayoutManager#smoothScrollToPosition(RecyclerTmView, State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see LayoutManager#smoothScrollToPosition(RecyclerTmView, State, int)
     */
     ...
     * {@link RecyclerTmView.LayoutManager#computeHorizontalScrollOffset(RecyclerTmView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see RecyclerTmView.LayoutManager#computeHorizontalScrollOffset
     * (RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link RecyclerTmView.LayoutManager#computeHorizontalScrollExtent(RecyclerTmView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see RecyclerTmView.LayoutManager#computeHorizontalScrollExtent(RecyclerTmView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link RecyclerTmView.LayoutManager#computeHorizontalScrollRange(RecyclerTmView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see RecyclerTmView.LayoutManager#computeHorizontalScrollRange(RecyclerTmView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link RecyclerTmView.LayoutManager#computeVerticalScrollOffset(RecyclerTmView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see RecyclerTmView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link RecyclerTmView.LayoutManager#computeVerticalScrollExtent(RecyclerTmView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see RecyclerTmView.LayoutManager#computeVerticalScrollExtent(RecyclerTmView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link RecyclerTmView.LayoutManager#computeVerticalScrollRange(RecyclerTmView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see RecyclerTmView.LayoutManager#computeVerticalScrollRange(RecyclerTmView.State)
     */
    @Override
     ...
     * {@link RecyclerTmView#requestLayout()}.  Doing so enables {@link RecyclerTmView} to avoid
     ...
     * child View to cause a call to {@link RecyclerTmView#requestLayout()}.
     *
     ...
     * {@link RecyclerTmView#requestLayout()}.
     * <p>
     * A call to this method must always be accompanied by a call to
     * {@link #startInterceptRequestLayout()} that precedes the code that may trigger a child
     * View to cause a call to {@link RecyclerTmView#requestLayout()}.
     *
    ...
    /**
     * Set a {@link EdgeEffectFactory} for this {@link RecyclerTmView}.
     * <p>
     ...
     * {@link EdgeEffectFactory#createEdgeEffect(RecyclerTmView, int)}
     *
     ...
     * returns true from
     * {@link OnItemTouchListener#onInterceptTouchEvent(RecyclerTmView, MotionEvent)} its
     * {@link OnItemTouchListener#onTouchEvent(RecyclerTmView, MotionEvent)} method will be called
     ...
     *
     * <p>Calls {@link OnItemTouchListener#onInterceptTouchEvent(RecyclerTmView, MotionEvent)} on each
     ...
     * OnItemTouchListener to be called for future {@link RecyclerTmView#onTouchEvent(MotionEvent)}
     ...
     * {@link LayoutManager#onItemsChanged(RecyclerTmView)} during measure/layout.
     */
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (!smoothScrollerPending && doneScrolling) {
                    ...
                    postOnAnimation();
                    if (mGapWorker != null) {
                        mGapWorker.postFromTraversal(RecyclerTmView.this, unconsumedX, unconsumedY);
                    }
                }
            }
        ...
        private void internalPostOnAnimation() {
            ...
            ViewCompat.postOnAnimation(RecyclerTmView.this, this);
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (POST_UPDATES_ON_ANIMATION && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(RecyclerTmView.this, mUpdateChildViewsRunnable);
            } else {
     ...
     *
     * @see RecyclerTmView#setEdgeEffectFactory(EdgeEffectFactory)
     */
    public static class EdgeEffectFactory {
         ...
         */
        protected @NonNull EdgeEffect createEdgeEffect(@NonNull RecyclerTmView view,
     ...
     * and use {@link RecyclerTmView#setRecycledViewPool(RecycledViewPool)}.
     * <p>
     ...
     */
    @Nullable
    static RecyclerTmView findNestedRecyclerView(@NonNull View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof RecyclerTmView) {
            return (RecyclerTmView) view;
        }
        final ViewGroup parent = (ViewGroup) view;
        final int count = parent.getChildCount();
        for (int i = 0; i < count; i++) {
            final View child = parent.getChildAt(i);
            final RecyclerTmView descendant = findNestedRecyclerView(child);
            if (descendant != null) {
                return descendant;
            }
        }
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder holder, int offsetPosition,
            ...
            holder.mOwnerRecyclerTmView = RecyclerTmView.this;
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    ...
                    holder = mAdapter.createViewHolder(RecyclerTmView.this, type);
                    if (ALLOW_THREAD_GAP_WORK) {
                        // only bother finding nested RV if prefetching
                        RecyclerTmView innerView = findNestedRecyclerView(holder.itemView);
                        if (innerView != null) {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (!cached && !recycled && transientStatePreventsRecycling) {
                holder.mOwnerRecyclerTmView = null;
            }
        }
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    ...
                    if (layoutIndex == RecyclerTmView.NO_POSITION) {
     ...
     * within a {@link RecyclerTmView}.</p>
     *
    ...
    public abstract static class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH holder, int position) {
            ...
            if (layoutParams instanceof RecyclerTmView.LayoutParams) {
         ...
         * needs to be attached to its parent {@link RecyclerTmView}. This can be because it has
         ...
         * <p>
         * Note that when all animations are created by {@link RecyclerTmView.ItemAnimator}, you
         ...
         * {@link #onViewDetachedFromWindow(RecyclerTmView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link RecyclerTmView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(RecyclerTmView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(RecyclerTmView.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(RecyclerTmView.AdapterDataObserver)
         */
         ...
         *
         * @param recyclerTmView The RecyclerView instance which started observing this adapter.
         * @see #onDetachedFromRecyclerView(RecyclerTmView)
         */
        public void onAttachedToRecyclerView(@NonNull RecyclerTmView recyclerTmView) {
        }

        /**
         * Called by RecyclerView when it stops observing this Adapter.
         *
         * @param recyclerTmView The RecyclerView instance which stopped observing this adapter.
         * @see #onAttachedToRecyclerView(RecyclerTmView)
         */
        public void onDetachedFromRecyclerView(@NonNull RecyclerTmView recyclerTmView) {
        }
    ...
    public abstract static class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
                new ViewBoundsCheck.Callback() {
                    ...
                    public int getChildStart(View view) {
                        final RecyclerTmView.LayoutParams params = (RecyclerTmView.LayoutParams)
         ...
         * {@link LinearLayoutTmManager#findOneVisibleChild(int, int, boolean, boolean)},
         * and {@link LinearLayoutTmManager#findOnePartiallyOrCompletelyInvisibleChild(int, int)}.
         */
        ...
        void setRecyclerView(RecyclerTmView recyclerTmView) {
            if (recyclerTmView == null) {
                mRecyclerTmView = null;
                mChildHelper = null;
                mWidth = 0;
                mHeight = 0;
            } else {
                mRecyclerTmView = recyclerTmView;
                mChildHelper = recyclerTmView.mChildHelper;
                mWidth = recyclerTmView.getWidth();
                mHeight = recyclerTmView.getHeight();
            }
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            final int count = getChildCount();
            if (count == 0) {
                mRecyclerTmView.defaultOnMeasure(widthSpec, heightSpec);
                return;
            }
            ...
            for (int i = 0; i < count; i++) {
                View child = getChildAt(i);
                final Rect bounds = mRecyclerTmView.mTempRect;
            ...
            mRecyclerTmView.mTempRect.set(minX, minY, maxX, maxY);
            setMeasuredDimension(mRecyclerTmView.mTempRect, widthSpec, heightSpec);
        }

        /**
         * Sets the measured dimensions from the given bounding box of the children and the
         * measurement specs that were passed into {@link RecyclerTmView#onMeasure(int, int)}. It is
         ...
         * {@link RecyclerTmView#onMeasure(int, int)}.
         * <p>
        ...
        public void assertInLayoutOrScroll(String message) {
            if (mRecyclerTmView != null) {
                mRecyclerTmView.assertInLayoutOrScroll(message);
            }
        }
        ...
        public void assertNotInLayoutOrScroll(String message) {
            if (mRecyclerTmView != null) {
                mRecyclerTmView.assertNotInLayoutOrScroll(message);
            }
        }

        /**
         * Defines whether the measuring pass of layout should use the AutoMeasure mechanism of
         * {@link RecyclerTmView} or if it should be done by the LayoutManager's implementation of
         ...
         * {@link RecyclerTmView#onMeasure(int, int)}, and then calculating desired dimensions based
         ...
         * More specifically:
         * <ol>
         * <li>When {@link RecyclerTmView#onMeasure(int, int)} is called, if the provided measure
         ...
         * <li>Any following calls to {@link RecyclerTmView#onMeasure(int, int)} will run
         * {@link #onLayoutChildren(Recycler, State)} with {@link State#isMeasuring()} set to
         ...
         * mechanism of {@link RecyclerTmView} or <code>False</code> if it should be done by the
         ...
         * {@link RecyclerTmView#setItemAnimator(ItemAnimator) ItemAnimator} set on the
        ...
        public final void setItemPrefetchEnabled(boolean enabled) {
            if (enabled != mItemPrefetchEnabled) {
                ...
                if (mRecyclerTmView != null) {
                    mRecyclerTmView.mRecycler.updateViewCacheSize();
                }
            }
        }
        ...
        void dispatchAttachedToWindow(RecyclerTmView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(RecyclerTmView view, Recycler recycler) {
        ...
        public void postOnAnimation(Runnable action) {
            if (mRecyclerTmView != null) {
                ViewCompat.postOnAnimation(mRecyclerTmView, action);
            }
        }
        ...
        public boolean removeCallbacks(Runnable action) {
            if (mRecyclerTmView != null) {
                return mRecyclerTmView.removeCallbacks(action);
            }
            return false;
        }
        /**
         ...
         *
         * @see #onDetachedFromWindow(RecyclerTmView, Recycler)
         */
        @CallSuper
        public void onAttachedToWindow(RecyclerTmView view) {
        }

        /**
         * @deprecated
         * override {@link #onDetachedFromWindow(RecyclerTmView, Recycler)}
         */
        @Deprecated
        public void onDetachedFromWindow(RecyclerTmView view) {
         ...
         * call {@link RecyclerTmView#requestLayout()} to ensure that it is re-laid out when
         ...
         *                 keeping them around.
         *
         * @see #onAttachedToWindow(RecyclerTmView)
         */
        @CallSuper
        public void onDetachedFromWindow(RecyclerTmView view, Recycler recycler) {
         ...
         */
        public boolean getClipToPadding() {
            return mRecyclerTmView != null && mRecyclerTmView.mClipToPadding;
        }
         ...
         * {@link RecyclerTmView.LayoutParams} for this purpose.</p>
         *
         ...
         * </p>
         * @param recyclerTmView The RecyclerView to which this layout manager is attached
         * @param state    Current State of RecyclerView
         * @param position Scroll to this adapter position.
         */
        public void smoothScrollToPosition(RecyclerTmView recyclerTmView, State state,
                                           int position) {
        ...
        public void startSmoothScroll(SmoothScroller smoothScroller) {
            ...
            mSmoothScroller.start(mRecyclerTmView, this);
        }
        ...
        public int getLayoutDirection() {
            return ViewCompat.getLayoutDirection(mRecyclerTmView);
        }
         ...
         * @see RecyclerTmView.ItemAnimator#endAnimations()
         */
        public void endAnimation(View view) {
            if (mRecyclerTmView.mItemAnimator != null) {
                mRecyclerTmView.mItemAnimator.endAnimation(getChildViewHolderInt(view));
            }
        }
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (disappearing || holder.isRemoved()) {
                ...
                mRecyclerTmView.mViewInfoStore.addToDisappearedInLayout(holder);
            } else {
                ...
                mRecyclerTmView.mViewInfoStore.removeFromDisappearedInLayout(holder);
            }
            final LayoutParams lp = (LayoutParams) child.getLayoutParams();
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
            ...
            } else if (child.getParent() == mRecyclerTmView) { // it was not a scrap but a valid child
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added View has RecyclerView as parent but"
                            ...
                            + mRecyclerTmView.indexOfChild(child) + mRecyclerTmView.exceptionLabel());
                }
                if (currentIndex != index) {
                    mRecyclerTmView.mLayout.moveView(currentIndex, index);
                }
            } else {
        ...
        public int getPosition(@NonNull View view) {
            return ((RecyclerTmView.LayoutParams) view.getLayoutParams()).getViewLayoutPosition();
        }
         ...
         *
         * @see RecyclerTmView#getChildViewHolder(View)
         * @see RecyclerTmView#findContainingViewHolder(View)
         */
        @Nullable
        public View findContainingItemView(@NonNull View view) {
            if (mRecyclerTmView == null) {
            ...
            View found = mRecyclerTmView.findContainingItemView(view);
            if (found == null) {
                return null;
            }
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (vh.getLayoutPosition() == position && !vh.shouldIgnore()
                        && (mRecyclerTmView.mState.isPreLayout() || !vh.isRemoved())) {
                    return child;
                }
            }
            return null;
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, RecyclerTmView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, RecyclerTmView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, RecyclerTmView.Recycler)}  scrapped}.
         *
        ...
        public void attachView(@NonNull View child, int index, LayoutParams lp) {
            ViewHolder vh = getChildViewHolderInt(child);
            if (vh.isRemoved()) {
                mRecyclerTmView.mViewInfoStore.addToDisappearedInLayout(vh);
            } else {
                mRecyclerTmView.mViewInfoStore.removeFromDisappearedInLayout(vh);
            }
        ...
        public void removeDetachedView(@NonNull View child) {
            mRecyclerTmView.removeDetachedView(child, false);
        }
        ...
        public void moveView(int fromIndex, int toIndex) {
            ...
            if (view == null) {
                throw new IllegalArgumentException("Cannot move a child from non-existing index:"
                        + fromIndex + mRecyclerTmView.toString());
            }
         ...
         *
         * <p>This value is usually equal to the laid out width of the {@link RecyclerTmView} but may
         ...
         *
         * <p>This value is usually equal to the laid out height of the {@link RecyclerTmView} but may
        ...
        public int getPaddingLeft() {
            return mRecyclerTmView != null ? mRecyclerTmView.getPaddingLeft() : 0;
        }
        ...
        public int getPaddingTop() {
            return mRecyclerTmView != null ? mRecyclerTmView.getPaddingTop() : 0;
        }
        ...
        public int getPaddingRight() {
            return mRecyclerTmView != null ? mRecyclerTmView.getPaddingRight() : 0;
        }
        ...
        public int getPaddingBottom() {
            return mRecyclerTmView != null ? mRecyclerTmView.getPaddingBottom() : 0;
        }
        ...
        public int getPaddingStart() {
            return mRecyclerTmView != null ? ViewCompat.getPaddingStart(mRecyclerTmView) : 0;
        }
        ...
        public int getPaddingEnd() {
            return mRecyclerTmView != null ? ViewCompat.getPaddingEnd(mRecyclerTmView) : 0;
        }
        ...
        public boolean isFocused() {
            return mRecyclerTmView != null && mRecyclerTmView.isFocused();
        }
        ...
        public boolean hasFocus() {
            return mRecyclerTmView != null && mRecyclerTmView.hasFocus();
        }
        ...
        public View getFocusedChild() {
            ...
            final View focused = mRecyclerTmView.getFocusedChild();
        ...
        public int getItemCount() {
            final Adapter a = mRecyclerTmView != null ? mRecyclerTmView.getAdapter() : null;
        ...
        public void offsetChildrenHorizontal(@Px int dx) {
            if (mRecyclerTmView != null) {
                mRecyclerTmView.offsetChildrenHorizontal(dx);
            }
        }
        ...
        public void offsetChildrenVertical(@Px int dy) {
            if (mRecyclerTmView != null) {
                mRecyclerTmView.offsetChildrenVertical(dy);
            }
        }
        ...
        public void ignoreView(@NonNull View view) {
            if (view.getParent() != mRecyclerTmView || mRecyclerTmView.indexOfChild(view) == -1) {
                // checking this because calling this method on a recycled or detached view may
                // cause loss of state.
                throw new IllegalArgumentException("View should be fully attached to be ignored"
                        + mRecyclerTmView.exceptionLabel());
            }
            final ViewHolder vh = getChildViewHolderInt(view);
            vh.addFlags(ViewHolder.FLAG_IGNORE);
            mRecyclerTmView.mViewInfoStore.removeViewHolder(vh);
        }
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ...
            if (viewHolder.isInvalid() && !viewHolder.isRemoved()
                    && !mRecyclerTmView.mAdapter.hasStableIds()) {
                removeViewAt(index);
                recycler.recycleViewHolderInternal(viewHolder);
            } else {
                detachViewAt(index);
                recycler.scrapView(view);
                mRecyclerTmView.mViewInfoStore.onViewDetached(viewHolder);
            }
        }
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                if (vh.isTmpDetached()) {
                    mRecyclerTmView.removeDetachedView(scrap, false);
                }
                if (mRecyclerTmView.mItemAnimator != null) {
                    mRecyclerTmView.mItemAnimator.endAnimation(vh);
                }
        ...
        public void measureChild(@NonNull View child, int widthUsed, int heightUsed) {
            ...
            final Rect insets = mRecyclerTmView.getItemDecorInsetsForChild(child);
        ...
        public void getTransformedBoundingBox(@NonNull View child, boolean includeDecorInsets,
            ...
            if (mRecyclerTmView != null) {
                ...
                if (childMatrix != null && !childMatrix.isIdentity()) {
                    final RectF tempRectF = mRecyclerTmView.mTempRectF;
                    tempRectF.set(out);
         ...
         */
        public void getDecoratedBoundsWithMargins(@NonNull View view, @NonNull Rect outBounds) {
            RecyclerTmView.getDecoratedBoundsWithMarginsInt(view, outBounds);
        }
        ...
        public void calculateItemDecorationsForChild(@NonNull View child, @NonNull Rect outRect) {
            ...
            Rect insets = mRecyclerTmView.getItemDecorInsetsForChild(child);
            outRect.set(insets);
        }
         ...
         * then {@link #onFocusSearchFailed(View, int, RecyclerTmView.Recycler, RecyclerTmView.State)}
         ...
         */
        public boolean requestChildRectangleOnScreen(@NonNull RecyclerTmView parent,
         ...
         */
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerTmView parent, int dx, int dy) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(RecyclerTmView, State, View, View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(@NonNull RecyclerTmView parent, @NonNull View child,
         ...
         */
        public boolean onRequestChildFocus(@NonNull RecyclerTmView parent, @NonNull State state,
         ...
         * {@link RecyclerTmView#setAdapter(Adapter)} or
         * {@link RecyclerTmView#swapAdapter(Adapter, boolean)}. The LayoutManager may use this
         ...
         *                   {@link #setAdapter(RecyclerTmView.Adapter)} is called with {@code null}.
         */
         ...
         *
         * @param recyclerTmView The RecyclerView hosting this LayoutManager
         ...
         */
        public boolean onAddFocusables(@NonNull RecyclerTmView recyclerTmView,
         ...
         * {@link RecyclerTmView#swapAdapter(Adapter, boolean)} ()} and signals that the the entire
         * data set has changed.
         *
         * @param recyclerTmView
         */
        public void onItemsChanged(@NonNull RecyclerTmView recyclerTmView) {
        }
         ...
         * @param itemCount
         */
        public void onItemsAdded(@NonNull RecyclerTmView recyclerTmView, int positionStart,
                                 int itemCount) {
        }
         ...
         * @param itemCount
         */
        public void onItemsRemoved(@NonNull RecyclerTmView recyclerTmView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter.
         * To receive payload,  override {@link #onItemsUpdated(RecyclerTmView, int, int, Object)}
         ...
         * @param itemCount
         */
        public void onItemsUpdated(@NonNull RecyclerTmView recyclerTmView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter and with optional payload.
         * Default implementation calls {@link #onItemsUpdated(RecyclerTmView, int, int)}.
         *
         * @param recyclerTmView
         * @param positionStart
         * @param itemCount
        ...
        public void onItemsUpdated(@NonNull RecyclerTmView recyclerTmView, int positionStart,
            ...
            onItemsUpdated(recyclerTmView, positionStart, itemCount);
        }
         ...
         * @param itemCount
         */
        public void onItemsMoved(@NonNull RecyclerTmView recyclerTmView, int from, int to,
                                 int itemCount) {
         ...
         *
         * <p>Read {@link RecyclerTmView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see RecyclerTmView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerTmView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see RecyclerTmView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerTmView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see RecyclerTmView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerTmView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see RecyclerTmView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerTmView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see RecyclerTmView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerTmView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see RecyclerTmView#computeVerticalScrollRange()
         */
        ...
        public void setMeasuredDimension(int widthSize, int heightSize) {
            mRecyclerTmView.setMeasuredDimension(widthSize, heightSize);
        }
        ...
        public int getMinimumWidth() {
            return ViewCompat.getMinimumWidth(mRecyclerTmView);
        }
        ...
        public int getMinimumHeight() {
            return ViewCompat.getMinimumHeight(mRecyclerTmView);
        }
        /**
        ...
        void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfoCompat info) {
            onInitializeAccessibilityNodeInfo(mRecyclerTmView.mRecycler, mRecyclerTmView.mState, info);
        }
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)},
         * {@link #getColumnCountForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)},
         * {@link #isLayoutHierarchical(RecyclerTmView.Recycler, RecyclerTmView.State)} and
         * {@link #getSelectionModeForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)} for
         ...
         * @see #getRowCountForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)
         * @see #getColumnCountForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)
         * @see #isLayoutHierarchical(RecyclerTmView.Recycler, RecyclerTmView.State)
         * @see #getSelectionModeForAccessibility(RecyclerTmView.Recycler, RecyclerTmView.State)
         */
        public void onInitializeAccessibilityNodeInfo(@NonNull Recycler recycler,
            ...
            if (mRecyclerTmView.canScrollVertically(-1) || mRecyclerTmView.canScrollHorizontally(-1)) {
        ...
        public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            onInitializeAccessibilityEvent(mRecyclerTmView.mRecycler, mRecyclerTmView.mState, event);
        }
        ...
        public void onInitializeAccessibilityEvent(@NonNull Recycler recycler, @NonNull State state,
            ...
            if (mRecyclerTmView == null || event == null) {
                return;
            }
            event.setScrollable(mRecyclerTmView.canScrollVertically(1)
                    || mRecyclerTmView.canScrollVertically(-1)
                    || mRecyclerTmView.canScrollHorizontally(-1)
                    || mRecyclerTmView.canScrollHorizontally(1));

            if (mRecyclerTmView.mAdapter != null) {
                event.setItemCount(mRecyclerTmView.mAdapter.getItemCount());
            }
        }
        ...
        void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (vh != null && !vh.isRemoved() && !mChildHelper.isHidden(vh.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(mRecyclerTmView.mRecycler,
                        mRecyclerTmView.mState, host, info);
            }
        }
        ...
        public int getRowCountForAccessibility(@NonNull Recycler recycler, @NonNull State state) {
            if (mRecyclerTmView == null || mRecyclerTmView.mAdapter == null) {
                return 1;
            }
            return canScrollVertically() ? mRecyclerTmView.mAdapter.getItemCount() : 1;
        }
        ...
        public int getColumnCountForAccessibility(@NonNull Recycler recycler,
            ...
            return canScrollHorizontally() ? mRecyclerTmView.mAdapter.getItemCount() : 1;
        }
        ...
        boolean performAccessibilityAction(int action, @Nullable Bundle args) {
            return performAccessibilityAction(mRecyclerTmView.mRecycler, mRecyclerTmView.mState,
                    action, args);
        }
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state,
            ...
            switch (action) {
                case AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD:
                    if (mRecyclerTmView.canScrollVertically(-1)) {
                        vScroll = -(getHeight() - getPaddingTop() - getPaddingBottom());
                    }
                    if (mRecyclerTmView.canScrollHorizontally(-1)) {
            ...
            mRecyclerTmView.smoothScrollBy(hScroll, vScroll);
            return true;
        }
        ...
        boolean performAccessibilityActionForItem(@NonNull View view, int action,
            ...
            return performAccessibilityActionForItem(mRecyclerTmView.mRecycler, mRecyclerTmView.mState,
                    view, action, args);
        }
        ...
        void setExactMeasureSpecsFrom(RecyclerTmView recyclerTmView) {
            setMeasureSpecs(
                    MeasureSpec.makeMeasureSpec(recyclerTmView.getWidth(), MeasureSpec.EXACTLY),
                    MeasureSpec.makeMeasureSpec(recyclerTmView.getHeight(), MeasureSpec.EXACTLY)
            );
        }
     ...
     * views (in {@link ItemDecoration#onDraw(Canvas, RecyclerTmView, RecyclerTmView.State) onDraw()}
     * and after the items (in {@link ItemDecoration#onDrawOver(Canvas, RecyclerTmView,
     * RecyclerTmView.State)}.</p>
     */
    public abstract static class ItemDecoration {
         ...
         * @param state The current state of RecyclerView
         */
        public void onDraw(@NonNull Canvas c, @NonNull RecyclerTmView parent, @NonNull State state) {
            onDraw(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDraw(Canvas, RecyclerTmView, RecyclerTmView.State)}
         */
        @Deprecated
        public void onDraw(@NonNull Canvas c, @NonNull RecyclerTmView parent) {
        }
         ...
         * @param state The current state of RecyclerView.
         */
        public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerTmView parent,
                @NonNull State state) {
            onDrawOver(c, parent);
        }
        ...
        /**
         * @deprecated
         * Override {@link #onDrawOver(Canvas, RecyclerTmView, RecyclerTmView.State)}
         */
        @Deprecated
        public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerTmView parent) {
        }
        ...
        /**
         * @deprecated
         * Use {@link #getItemOffsets(Rect, View, RecyclerTmView, State)}
         */
        @Deprecated
        public void getItemOffsets(@NonNull Rect outRect, int itemPosition,
                @NonNull RecyclerTmView parent) {
            outRect.set(0, 0, 0, 0);
        }
         ...
         * {@link RecyclerTmView#getChildAdapterPosition(View)} to get the adapter position of the
         * View.
         *
        ...
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
                                   @NonNull RecyclerTmView parent, @NonNull State state) {
    ...
    public interface OnItemTouchListener {
         ...
         *         the gesture.
         */
        boolean onInterceptTouchEvent(@NonNull RecyclerTmView rv, @NonNull MotionEvent e);
         ...
         *          the RecyclerView's coordinate system.
         */
        void onTouchEvent(@NonNull RecyclerTmView rv, @NonNull MotionEvent e);
    ...
    /**
     * An implementation of {@link RecyclerTmView.OnItemTouchListener} that has empty method bodies
     ...
     */
    public static class SimpleOnItemTouchListener implements RecyclerTmView.OnItemTouchListener {
        @Override
        public boolean onInterceptTouchEvent(@NonNull RecyclerTmView rv, @NonNull MotionEvent e) {
            return false;
        }

        @Override
        public void onTouchEvent(@NonNull RecyclerTmView rv, @NonNull MotionEvent e) {
        }
     ...
     * <p>
     * @see RecyclerTmView#addOnScrollListener(OnScrollListener)
     * @see RecyclerTmView#clearOnChildAttachStateChangeListeners()
     *
     */
    public abstract static class OnScrollListener {
         ...
         *
         * @param recyclerTmView The RecyclerView whose scroll state has changed.
         * @param newState     The updated scroll state. One of {@link #SCROLL_STATE_IDLE},
         *                     {@link #SCROLL_STATE_DRAGGING} or {@link #SCROLL_STATE_SETTLING}.
         */
        public void onScrollStateChanged(@NonNull RecyclerTmView recyclerTmView, int newState){}
         ...
         *
         * @param recyclerTmView The RecyclerView which scrolled.
         * @param dx The amount of horizontal scroll.
         * @param dy The amount of vertical scroll.
         */
        public void onScrolled(@NonNull RecyclerTmView recyclerTmView, int dx, int dy){}
    }
     ...
     * a view is recycled.
     *
     * @see RecyclerTmView#setRecyclerListener(RecyclerListener)
     */
    ...
    public abstract static class ViewHolder {
        ...
        WeakReference<RecyclerTmView> mNestedRecyclerView;
         ...
         * {@link RecycledViewPool}.
         */
        RecyclerTmView mOwnerRecyclerTmView;
         ...
         * positions. All methods in {@link RecyclerTmView.LayoutManager}, {@link RecyclerTmView.State},
         * {@link RecyclerTmView.Recycler} that receive a position expect it to be the layout position
         * of the item.
         * <p>
         * If LayoutManager needs to call an external method that requires the adapter position of
         * the item, it can use {@link #getAdapterPosition()} or
         * {@link RecyclerTmView.Recycler#convertPreLayoutPositionToPostLayout(int)}.
         *
         ...
         * <p>
         * Note that if you've called {@link RecyclerTmView.Adapter#notifyDataSetChanged()}, until the
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         *
         * @return The adapter position of the item if it still exists in the adapter.
         * {@link RecyclerTmView#NO_POSITION} if item has been removed from the adapter,
         * {@link RecyclerTmView.Adapter#notifyDataSetChanged()} has been called after the last
         * layout pass or the ViewHolder has already been recycled.
         */
        public final int getAdapterPosition() {
            if (mOwnerRecyclerTmView == null) {
                return NO_POSITION;
            }
            return mOwnerRecyclerTmView.getAdapterPositionFor(this);
        }
         ...
         *
         * @return The item's id if adapter has stable ids, {@link RecyclerTmView#NO_ID}
         * otherwise
         */
        ...
        boolean isAttachedToTransitionOverlay() {
            return itemView.getParent() != null && itemView.getParent() != mOwnerRecyclerTmView;
        }
         ...
         */
        void onEnteredHiddenState(RecyclerTmView parent) {
         ...
         */
        void onLeftHiddenState(RecyclerTmView parent) {
            parent.setChildImportantForAccessibilityInternal(this,
                    mWasImportantForAccessibilityBeforeHidden);
            mWasImportantForAccessibilityBeforeHidden = ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;
        }
    ...
    int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(ViewHolder.FLAG_INVALID
                ...
                || !viewHolder.isBound()) {
            return RecyclerTmView.NO_POSITION;
        }
     ...
     * {@link RecyclerTmView}. Custom {@link LayoutManager layout managers} are encouraged
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
         ...
         * {@link RecyclerTmView#NO_POSITION} if item represented by this View has been removed or
    ...
    public abstract static class SmoothScroller {
        ...
        private int mTargetPosition = RecyclerTmView.NO_POSITION;

        private RecyclerTmView mRecyclerTmView;
         ...
         * <p>In each animation step, {@link RecyclerTmView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, RecyclerTmView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, RecyclerTmView.State, SmoothScroller.Action)} until
         ...
         */
        void start(RecyclerTmView recyclerTmView, LayoutManager layoutManager) {

            // Stop any previous ViewFlinger animations now because we are about to start a new one.
            recyclerTmView.mViewFlinger.stop();
            ...
            if (mTargetPosition == RecyclerTmView.NO_POSITION) {
                throw new IllegalArgumentException("Invalid target position");
            }
            mRecyclerTmView.mState.mTargetPosition = mTargetPosition;
            mRunning = true;
            mPendingInitialRun = true;
            mTargetView = findViewByPosition(getTargetPosition());
            onStart();
            mRecyclerTmView.mViewFlinger.postOnAnimation();
         ...
         * {@link #onTargetFound(android.view.View, RecyclerTmView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, RecyclerTmView.State, SmoothScroller.Action)}.
         */
        protected final void stop() {
            ...
            mRunning = false;
            onStop();
            mRecyclerTmView.mState.mTargetPosition = RecyclerTmView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = RecyclerTmView.NO_POSITION;
         ...
         * {@link RecyclerTmView#NO_POSITION} if no target view is set.
         */
        ...
        void onAnimation(int dx, int dy) {
            final RecyclerTmView recyclerTmView = mRecyclerTmView;
            if (mTargetPosition == RecyclerTmView.NO_POSITION || recyclerTmView == null) {
                stop();
            }
            ...
            if (mTargetView != null) {
                ...
                if (getChildPosition(mTargetView) == mTargetPosition) {
                    onTargetFound(mTargetView, recyclerTmView.mState, mRecyclingAction);
                    mRecyclingAction.runIfNecessary(recyclerTmView);
                    stop();
                } else {
            ...
            if (mRunning) {
                onSeekTargetStep(dx, dy, recyclerTmView.mState, mRecyclingAction);
                ...
                if (hadJumpTarget) {
                    ...
                    if (mRunning) {
                        mPendingInitialRun = true;
                        recyclerTmView.mViewFlinger.postOnAnimation();
                    }
                }
            }
        }
        ...
        /**
         * @see RecyclerTmView#getChildLayoutPosition(android.view.View)
         */
        public int getChildPosition(View view) {
            return mRecyclerTmView.getChildLayoutPosition(view);
        }

        /**
         * @see RecyclerTmView.LayoutManager#getChildCount()
         */
        public int getChildCount() {
            return mRecyclerTmView.mLayout.getChildCount();
        }

        /**
         * @see RecyclerTmView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
            return mRecyclerTmView.mLayout.findViewByPosition(position);
        }

        /**
         * @see RecyclerTmView#scrollToPosition(int)
         * @deprecated Use {@link Action#jumpTo(int)}.
         */
        @Deprecated
        public void instantScrollToPosition(int position) {
            mRecyclerTmView.scrollToPosition(position);
        }
        ...
        public static class Action {
            ...
            public static final int UNDEFINED_DURATION = RecyclerTmView.UNDEFINED_DURATION;
             ...
             * {@link RecyclerTmView#scrollToPosition(int)}.
             * <p>
            ...
            void runIfNecessary(RecyclerTmView recyclerTmView) {
                if (mJumpToPosition >= 0) {
                    final int position = mJumpToPosition;
                    mJumpToPosition = NO_POSITION;
                    recyclerTmView.jumpToPositionForSmoothScroller(position);
                    mChanged = false;
                    return;
                }
                if (mChanged) {
                    validate();
                    recyclerTmView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
                    mConsecutiveUpdates++;
        ...
        /**
         * An interface which is optionally implemented by custom {@link RecyclerTmView.LayoutManager}
    ...
    public static class State {
        ...
        int mTargetPosition = RecyclerTmView.NO_POSITION;
        ...
        /**
         * True if the associated {@link RecyclerTmView} is in the pre-layout step where it is having
        ...
        /**
         * Returns true if the {@link RecyclerTmView} is in the pre-layout step where it is having its
         ...
         * {@link RecyclerTmView#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != RecyclerTmView.NO_POSITION;
        }
    ...
    public abstract static class ItemAnimator {
         ...
         *                 {@link RecyclerTmView.Adapter#notifyDataSetChanged()}. The same list of
         *                 payloads will be passed into
         *                 {@link RecyclerTmView.Adapter#onBindViewHolder(ViewHolder, int, List)}
         ...
         * {@link #recordPreLayoutInformation(RecyclerTmView.State, ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(RecyclerTmView.State, ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
            ...
            /**
             * The change flags that were passed to
             * {@link #recordPreLayoutInformation(RecyclerTmView.State, ViewHolder, int, List)}.
             */
            @AdapterChanges
             ...
             */
            @NonNull
            public ItemHolderInfo setFrom(@NonNull RecyclerTmView.ViewHolder holder) {
             ...
             *               {@link #recordPreLayoutInformation(RecyclerTmView.State, ViewHolder, int,
             *               List)}.
             * @return This {@link ItemHolderInfo}
             */
            @NonNull
    ...
    public interface ChildDrawingOrderCallback {
         ...
         *
         * @see RecyclerTmView#setChildDrawingOrderCallback(RecyclerTmView.ChildDrawingOrderCallback)
         */
