...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final RecyclerTmView mRecyclerTmView;
    final AccessibilityDelegateCompat mItemDelegate;


    public RecyclerViewAccessibilityDelegate(@NonNull RecyclerTmView recyclerTmView) {
        mRecyclerTmView = recyclerTmView;
        mItemDelegate = new ItemDelegate(this);
    }

    boolean shouldIgnore() {
        return mRecyclerTmView.hasPendingAdapterUpdates();
    }
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) {
        ...
        if (!shouldIgnore() && mRecyclerTmView.getLayoutManager() != null) {
            return mRecyclerTmView.getLayoutManager().performAccessibilityAction(action, args);
        }
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
        ...
        if (!shouldIgnore() && mRecyclerTmView.getLayoutManager() != null) {
            mRecyclerTmView.getLayoutManager().onInitializeAccessibilityNodeInfo(info);
        }
    }
    ...
    public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
        ...
        if (host instanceof RecyclerTmView && !shouldIgnore()) {
            RecyclerTmView rv = (RecyclerTmView) host;
    ...
    public static class ItemDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (!mRecyclerViewDelegate.shouldIgnore()
                    && mRecyclerViewDelegate.mRecyclerTmView.getLayoutManager() != null) {
                mRecyclerViewDelegate.mRecyclerTmView.getLayoutManager()
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            if (!mRecyclerViewDelegate.shouldIgnore()
                    && mRecyclerViewDelegate.mRecyclerTmView.getLayoutManager() != null) {
                return mRecyclerViewDelegate.mRecyclerTmView.getLayoutManager()
