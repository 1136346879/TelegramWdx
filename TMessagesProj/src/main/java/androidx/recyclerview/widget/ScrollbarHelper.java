...
class ScrollbarHelper {
     ...
     */
    static int computeScrollOffset(RecyclerTmView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, RecyclerTmView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(RecyclerTmView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, RecyclerTmView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollRange(RecyclerTmView.State state, OrientationHelper orientation,
                                  View startChild, View endChild, RecyclerTmView.LayoutManager lm,
                                  boolean smoothScrollbarEnabled) {
        if (lm.getChildCount() == 0 || state.getItemCount() == 0 || startChild == null
                || endChild == null) {
