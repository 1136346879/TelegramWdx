...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        view.setLayoutParams(new RecyclerTmView.LayoutParams(RecyclerTmView.LayoutParams.MATCH_PARENT, viewType == 5 ? RecyclerTmView.LayoutParams.MATCH_PARENT : RecyclerTmView.LayoutParams.WRAP_CONTENT));
        return new RecyclerListView.Holder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerTmView.ViewHolder holder, int i) {
