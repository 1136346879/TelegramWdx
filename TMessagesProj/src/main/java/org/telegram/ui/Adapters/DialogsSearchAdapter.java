...
public class DialogsSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private class CategoryAdapterRecycler extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setLayoutParams(new RecyclerTmView.LayoutParams(AndroidUtilities.dp(80), AndroidUtilities.dp(86)));
    ...
    public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 5) {
            view.setLayoutParams(new RecyclerTmView.LayoutParams(RecyclerTmView.LayoutParams.MATCH_PARENT, AndroidUtilities.dp(86)));
        } else {
