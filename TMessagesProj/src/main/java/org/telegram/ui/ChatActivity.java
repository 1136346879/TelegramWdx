...
import androidx.recyclerview.widget.LinearLayoutTmManager;
import androidx.recyclerview.widget.LinearSmoothScrollerMiddle;
import androidx.recyclerview.widget.RecyclerTmView;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    private LinearLayoutTmManager mentionLayoutManager;
    ...
    public View createView(Context context) {
        ...
        chatLayoutManager = new GridLayoutManagerFixed(context, 1000, LinearLayoutTmManager.VERTICAL, true) {
            @Override
            ...
            @Override
            public void smoothScrollToPosition(RecyclerTmView recyclerTmView, RecyclerTmView.State state, int position) {
                LinearSmoothScrollerMiddle linearSmoothScroller = new LinearSmoothScrollerMiddle(recyclerTmView.getContext());
        ...
        chatListView.addItemDecoration(new RecyclerTmView.ItemDecoration() {
            @Override
            public void getItemOffsets(Rect outRect, View view, RecyclerTmView parent, RecyclerTmView.State state) {
                outRect.bottom = 0;
                if (view instanceof ChatMessageCell) {
                    ChatMessageCell cell = (ChatMessageCell) view;
                    MessageObject.GroupedMessages group = cell.getCurrentMessagesGroup();
        ...
        chatListView.setOnScrollListener(new RecyclerTmView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerTmView recyclerTmView, int newState) {
                if (newState == RecyclerTmView.SCROLL_STATE_IDLE) {
                    ...
                    if (newState == RecyclerTmView.SCROLL_STATE_SETTLING) {
                        wasManualScroll = true;
                        scrollingChatListView = true;
                    } else if (newState == RecyclerTmView.SCROLL_STATE_DRAGGING) {
                        wasManualScroll = true;
        ...
        mentionLayoutManager = new LinearLayoutTmManager(context) {
            @Override
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }
        };
        mentionLayoutManager.setOrientation(LinearLayoutTmManager.VERTICAL);
        ...
        mentionListView.addItemDecoration(new RecyclerTmView.ItemDecoration() {
            @Override
            public void getItemOffsets(Rect outRect, View view, RecyclerTmView parent, RecyclerTmView.State state) {
                outRect.left = 0;
                outRect.right = 0;
        ...
        mentionListView.setOnScrollListener(new RecyclerTmView.OnScrollListener() {

            @Override
            public void onScrollStateChanged(RecyclerTmView recyclerTmView, int newState) {
                mentionListViewIsScrolling = newState == RecyclerTmView.SCROLL_STATE_DRAGGING;
            }
            ...
            public void onScrolled(RecyclerTmView recyclerTmView, int dx, int dy) {
                ...
                int visibleItemCount = lastVisibleItem == RecyclerTmView.NO_POSITION ? 0 : lastVisibleItem;
        ...
        LinearLayoutTmManager layoutManager = new LinearLayoutTmManager(context);
        layoutManager.setOrientation(LinearLayoutTmManager.HORIZONTAL);
    ...
    private void checkScrollForLoad(boolean scroll) {
        ...
        int firstVisibleItem = chatLayoutManager.findFirstVisibleItemPosition();
        int visibleItemCount = firstVisibleItem == RecyclerTmView.NO_POSITION ? 0 : Math.abs(chatLayoutManager.findLastVisibleItemPosition() - firstVisibleItem) + 1;
        int totalItemCount = chatAdapter.getItemCount();
        int checkLoadCount;
        if (scroll) {
            checkLoadCount = 25;
            ...
            if (guid == classGuid) {
                ...
                if (load_type == 1) {
                    ...
                    if (newRowsCount > 0) {
                        ...
                        if (goodPosition != RecyclerTmView.NO_POSITION) {
            ...
            if (did == dialog_id) {
                ...
                if (!forwardEndReached[0]) {
                    ...
                    if (chatListView != null && chatAdapter != null) {
                        ...
                        if (lastVisible == RecyclerTmView.NO_POSITION) {
                            lastVisible = 0;
                        }
    ...
    private void checkListViewPaddingsInternal() {
        ...
        try {
            int firstVisPos = chatLayoutManager.findFirstVisibleItemPosition();
            int lastVisPos = RecyclerTmView.NO_POSITION;
            if (!wasManualScroll && unreadMessageObject != null) {
                ...
                if (pos >= 0) {
                    ...
                    firstVisPos = RecyclerTmView.NO_POSITION;
                }
            }
            int top = 0;
            if (firstVisPos != RecyclerTmView.NO_POSITION) {
                View firstVisView = chatLayoutManager.findViewByPosition(firstVisPos);
            ...
            } else if (lastVisPos != RecyclerTmView.NO_POSITION) {
    ...
    private void updateVisibleRows() {
        ...
        int lastVisibleItem = RecyclerTmView.NO_POSITION;
        ...
        chatListView.invalidate();
        if (lastVisibleItem != RecyclerTmView.NO_POSITION) {
    ...
    public class ChatActivityAdapter extends RecyclerTmView.Adapter {
        ...
        public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setLayoutParams(new RecyclerTmView.LayoutParams(RecyclerTmView.LayoutParams.MATCH_PARENT, RecyclerTmView.LayoutParams.WRAP_CONTENT));
        ...
        @Override
        public void onViewAttachedToWindow(RecyclerTmView.ViewHolder holder) {
            if (holder.itemView instanceof ChatMessageCell) {
