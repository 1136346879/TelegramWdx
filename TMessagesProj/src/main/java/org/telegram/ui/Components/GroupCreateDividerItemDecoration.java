...
public class GroupCreateDividerItemDecoration extends RecyclerTmView.ItemDecoration {
    ...
    @Override
    public void onDraw(Canvas canvas, RecyclerTmView parent, RecyclerTmView.State state) {
