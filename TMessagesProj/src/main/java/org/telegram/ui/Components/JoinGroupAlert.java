...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(final Context context, TLRPC.ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        if (!invite.participants.isEmpty()) {
            ...
            listView.setLayoutManager(new LinearLayoutTmManager(getContext(), LinearLayoutTmManager.HORIZONTAL, false));
    ...
    private class UsersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setLayoutParams(new RecyclerTmView.LayoutParams(AndroidUtilities.dp(100), AndroidUtilities.dp(90)));
