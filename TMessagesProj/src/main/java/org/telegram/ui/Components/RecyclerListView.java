...
public class RecyclerListView extends RecyclerTmView {
    ...
    private class FastScroll extends View {
        ...
        private void getCurrentLetter() {
            ...
            if (layoutManager instanceof LinearLayoutTmManager) {
                LinearLayoutTmManager linearLayoutTmManager = (LinearLayoutTmManager) layoutManager;
                if (linearLayoutTmManager.getOrientation() == LinearLayoutTmManager.VERTICAL) {
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        linearLayoutTmManager.scrollToPositionWithOffset(position, sectionOffset);
    ...
    private class RecyclerListViewItemClickListener implements OnItemTouchListener {
        ...
        @Override
        public boolean onInterceptTouchEvent(RecyclerTmView view, MotionEvent event) {
        ...
        @Override
        public void onTouchEvent(RecyclerTmView view, MotionEvent event) {
        ...
        super.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerTmView recyclerTmView, int newState) {
                ...
                if (onScrollListener != null) {
                    onScrollListener.onScrollStateChanged(recyclerTmView, newState);
                }
            ...
            public void onScrolled(RecyclerTmView recyclerTmView, int dx, int dy) {
                if (onScrollListener != null) {
                    onScrollListener.onScrolled(recyclerTmView, dx, dy);
                }
                ...
                if (linearLayoutTmManager.getOrientation() == LinearLayoutTmManager.VERTICAL) {
                    if (sectionsAdapter != null) {
                        ...
                        if (sectionsType == 1) {
                            ...
                            int lastVisibleItem = linearLayoutTmManager.findLastVisibleItemPosition();
                        ...
                        int firstVisibleItem = linearLayoutTmManager.findFirstVisibleItemPosition();
                        int lastVisibleItem = linearLayoutTmManager.findLastVisibleItemPosition();
                        int visibleItemCount = Math.abs(lastVisibleItem - firstVisibleItem) + 1;
    ...
    private void highlightRowInternal(RecyclerListView.IntReturnCallback callback, boolean canHighlightLater) {
        ...
        RecyclerTmView.ViewHolder holder = findViewHolderForAdapterPosition(callback.run());
        if (holder != null) {
