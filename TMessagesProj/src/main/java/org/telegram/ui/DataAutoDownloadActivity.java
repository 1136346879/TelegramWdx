...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    private class PresetChooseView extends View {
        ...
        private void setPreset(int index) {
            ...
            for (int a = 0; a < 3; a++) {
                RecyclerTmView.ViewHolder holder = listView.findViewHolderForAdapterPosition(photosRow + a);
                if (holder != null) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            if (position == autoDownloadRow) {
                ...
                if (LocaleController.isRTL && x <= AndroidUtilities.dp(76) || !LocaleController.isRTL && x >= view.getMeasuredWidth() - AndroidUtilities.dp(76)) {
                    ...
                    cell.setChecked(!checked);
                    RecyclerTmView.ViewHolder holder = listView.findContainingViewHolder(view);
                    if (holder != null) {
    ...
    private void fillPresets() {
        ...
        if (listView != null) {
            RecyclerTmView.ViewHolder holder = listView.findViewHolderForAdapterPosition(usageProgressRow);
            if (holder != null) {
