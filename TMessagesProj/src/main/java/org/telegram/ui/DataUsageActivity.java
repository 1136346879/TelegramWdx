...
public class DataUsageActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        for (int a = 0; a < viewPages.length; a++) {
            ...
            final LinearLayoutTmManager layoutManager = viewPages[a].layoutManager = new LinearLayoutTmManager(context, LinearLayoutTmManager.VERTICAL, false) {
                @Override
            ...
            viewPages[a].listView.setOnScrollListener(new RecyclerTmView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerTmView recyclerTmView, int dx, int dy) {
                    if (recyclerTmView == viewPages[0].listView) {
    ...
    private void switchToCurrentSelectedMode(boolean animated) {
        ...
        int a = animated ? 1 : 0;
        RecyclerTmView.Adapter currentAdapter = viewPages[a].listView.getAdapter();
