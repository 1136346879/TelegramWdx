...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (messageObject == null && chatLocation == null) {
            ...
            searchListView.setVisibility(View.GONE);
            searchListView.setLayoutManager(new LinearLayoutTmManager(context, LinearLayoutTmManager.VERTICAL, false));
            ...
            searchListView.setOnScrollListener(new RecyclerTmView.OnScrollListener() {
                @Override
