...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        for (int a = 0; a < viewPages.length; a++) {
            ...
            RecyclerTmView.OnScrollListener onScrollListener = viewPages[a].listView.getOnScrollListener();
    ...
    private void switchToCurrentSelectedMode(boolean animated) {
        ...
        if (actionBar.getTranslationY() != 0) {
            LinearLayoutTmManager layoutManager = (LinearLayoutTmManager) viewPages[a].listView.getLayoutManager();
