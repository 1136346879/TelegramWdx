...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        listView.setLayoutManager(new LinearLayoutTmManager(context) {
            @Override
            ...
            public void onItemClick(View view, int position) {
                if (position == customRow && view instanceof TextCheckBoxCell) {
                    ...
                    if (position == soundRow) {
                        ...
                        list.setLayoutManager(new LinearLayoutTmManager(context, LinearLayoutTmManager.VERTICAL, false));
                        ...
                        list.setAdapter(new RecyclerListView.SelectionAdapter() {
                            ...
                            public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                                ...
                                textView.setLayoutParams(new RecyclerTmView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
