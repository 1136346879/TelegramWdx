        ...
        public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 1:
                    ...
                    LinearLayoutTmManager layoutManager = new LinearLayoutTmManager(mContext) {
                        @Override
                        public boolean supportsPredictiveItemAnimations() {
                            return false;
                        }
            ...
            if (viewType == 1) {
                view.setLayoutParams(new RecyclerTmView.LayoutParams(RecyclerTmView.LayoutParams.MATCH_PARENT, AndroidUtilities.dp(60)));
            } else {
